...
const styles = StyleSheet.create({
  ...
  chip: { minHeight: 38, maxWidth: 360, padding: 3, borderWidth: 1, alignItems: "center", justifyContent: "center", flexDirection: "row", borderRadius: 14 },
  chipLabel: { minHeight: 30, flexShrink: 1, minWidth: 0, paddingHorizontal: 10, alignItems: "center", justifyContent: "center", borderRadius: 10 },
  chipText: { fontSize: 13, fontWeight: "800", maxWidth: 280 },
  ...
  bookTitle: { flex: 1, minWidth: 0, fontSize: 16, lineHeight: 22, fontWeight: "800" },
  ...
  bookMeta: { flexShrink: 1, minWidth: 0, fontSize: 12, fontWeight: "600" },
