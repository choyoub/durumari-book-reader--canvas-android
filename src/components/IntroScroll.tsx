...
const styles = StyleSheet.create({
  ...
  artworkRegion: { flex: 2, minHeight: 0, width: "100%", alignItems: "center", justifyContent: "center" },
  introFooter: { flex: 1, width: "100%", alignItems: "center", justifyContent: "flex-start", paddingHorizontal: 24, paddingTop: 8 },
